      ...
      <v-col cols="12" class="ma-1">
        ...
        <v-row class="mb-3 mr-1">
          ...
          <v-card width="100%" class="mt-5">
            ...
            >
              <v-toolbar-title class="text-center"
                >Thông tin vào trường</v-toolbar-title
              >
              <v-spacer></v-spacer>
            </v-toolbar>
          ...
          <v-card width="100%" class="mt-5">
            ...
            >
              <v-toolbar-title class="text-center"
                >Thông tin liên lạc phụ huynh học sinh</v-toolbar-title
              >
...
export default {
  ...
  async mounted() {
    ...
    AppService.getStudentDetailInformationByYear(this.$route.query.student_code, this.$store.getters["year"]).then((data)=> {
  ...
  methods: {
    ...
    //   getBase64(this.image).then((data)=>{this.imageBase64 = data})
