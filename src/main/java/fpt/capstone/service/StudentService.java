...
public interface StudentService {
    ...
    ServiceResult<List<StudentVo>> getAllStudentByNameOrCodeInClass(String status, String class_id, String search_word, String grade_level, String years);
    ...
    ServiceResult<List<StudentDetailInformationVo>> getStudentDetailInformation(String student_code);
