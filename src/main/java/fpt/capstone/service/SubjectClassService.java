...
public interface SubjectClassService {
    ...
    ServiceResult<Map<String, Object>> loadScreen();

    ServiceResult<Map<String, Object>> getSubjectClassByClassIdSubjetId(Integer classId);

    ServiceResult<Map<String, Object>> getSubjectClassByClassIdSubjetIdSemester(Integer classId, Integer semester);
}
