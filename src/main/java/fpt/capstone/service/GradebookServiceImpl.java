    ...
    private ServiceResult<Map<String, Object>> getStudentListWithEachScore(GradeBookForm gradeBookForm) {
        ...
        try {
            ...
            if (gradeBookForm.getSemester().equals("1")) {
                output.put("canUpdate", teachingAssignmentRepository.isTeachingforSemester1(gradeBookForm.getSubjectCode(), gradeBookForm.getClassCode(), username));
            } else {
                output.put("canUpdate", teachingAssignmentRepository.isTeachingforSemester2(gradeBookForm.getSubjectCode(), gradeBookForm.getClassCode(), username));
            }
...
//            style.setFont(font);
    ...
    public ServiceResult<Boolean> importExcelScore(MultipartFile file, String subjectCode, String classCode, String schoolYear, String semester, String login) throws IOException {
        ...
        try {
            ...
            e.printStackTrace();
            return new ServiceResult<>(HttpStatus.BAD_REQUEST, "Lưu điểm thất bại : " + e.getMessage(), null);
        }
    }
...
//tao ten cac dau diem
            ...
            e.printStackTrace();
            throw new ValidationException("file", "Không thể export file " + e.getMessage());
        }
    }
    ...
    public ServiceResult<Boolean> importExcelGrade(MultipartFile file, String subjectCode, String classCode, String schoolYear, String semester, String login) throws IOException {
        ...
        try {
            ...
            e.printStackTrace();
            return new ServiceResult<>(HttpStatus.BAD_REQUEST, "Cập nhật điểm thất bại : " + e.getMessage(), null);
        }
