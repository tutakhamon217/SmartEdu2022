...
public class StudentController {
    ...
    ServiceResult<List<StudentVo>> getDropDownValues(@RequestParam("status") String status, @RequestParam("class_code") String class_code, @RequestParam("search_word") String search_word, @RequestParam("grade_level") String grade_level, @RequestParam("years") String years)
    {
        return service.getAllStudentByNameOrCodeInClass(status, class_code, search_word, grade_level, years);
    }
    ...
    {
        return service.getStudentDetailInformation(form.getId());
    }
